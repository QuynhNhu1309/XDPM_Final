...
namespace WebForm
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/Custom").Include("~/Content/Custom/style.css"));

            bundles.Add(new StyleBundle("~/Content/Bootstrap").Include("~/Content/Bootstrap/bootstrap*"));
