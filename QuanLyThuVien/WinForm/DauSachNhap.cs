...
namespace WinForm
{
    public partial class DauSachNhap : Form
    {
        ...
        private void DauSachNhap_Load(object sender, EventArgs e)
        {
            //txt_thanhtien.Text = (Convert.ToInt32(txt_soluong.Text) * Convert.ToInt32(txt_gianhap.Text)).ToString();
            float soluong;
            float gianhap;
            ...
            //tac_gia_them.SelectedValue = ds.tac_gia.id;



            //loai_sach_them.SelectedValue = ds.loai_sach.id;
            

            //else
            //{
            //     if (isNumeric_soluong == false)
            //    {
